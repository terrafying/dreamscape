...
const DREAMERS = [
    ...
    dreams: [
      {
        ...
        extraction: {
          ...
          characters: [{ label: 'Self as Reader', known: true, archetype: 'The Witness' }],
          setting: { type: 'Library', quality: 'luminous', time: 'timeless' },
          narrative_arc: 'ascending',
          lucidity: 3,
          tone: 'Revelatory, cosmic, purposeful',
          interpretation: 'The dreamer is recognizing their role as a conscious participant in reality creation.',
          astro_context: {
          ...
          recommendations: [
            { action: 'Write down the patterns you notice', timing: 'Daily for 7 days', why: 'Anchor the prophetic insight' },
          ],
        },
      },
    ],
    ...
    dreams: [
      {
        ...
        extraction: {
          ...
          characters: [{ label: 'Self as Alchemist', known: true, archetype: 'The Transformer' }],
          setting: { type: 'Laboratory', quality: 'reflective', time: 'eternal' },
          narrative_arc: 'ascending',
          lucidity: 3,
          tone: 'Transformative, paradoxical, empowering',
          interpretation: 'The dreamer is integrating shadow material and discovering that opposites contain each other.',
          astro_context: {
          ...
          recommendations: [
            { action: 'Sit with the paradox', timing: 'Meditation, 20 min daily', why: 'Integrate the insight' },
          ],
        },
      },
    ],
    ...
    dreams: [
      {
        ...
        extraction: {
          ...
          interpretation: 'Direct experience of non-dual consciousness. The dreamer has accessed a state of unity consciousness.',
          astro_context: {
          ...
          recommendations: [
            { action: 'Ground this experience in the body', timing: 'Daily embodiment practice', why: 'Integrate transcendent experience' },
          ],
        },
      },
    ],
    ...
    dreams: [
      {
        ...
        extraction: {
          ...
          characters: [{ label: 'Woman with My Eyes', known: false, archetype: 'The Future Self' }],
          setting: { type: 'Threshold between worlds', quality: 'luminous', time: 'future' },
          narrative_arc: 'ascending',
          lucidity: 3,
          tone: 'Prophetic, purposeful, urgent',
          interpretation: 'Precognitive dream indicating a significant life transition in approximately 3 months.',
          astro_context: {
            moon_phase: 'New Moon',
            moon_sign: 'Aries',
  ...
  },
  {
    ...
    avatar_seed: 'worlds',
    email: 'the_dreamer_of_worlds@dreamscape.local',
    dreams: [
      {
        date: '2025-03-21',
        ...
        extraction: {
          ...
          characters: [{ label: 'Other Dreamers', known: false, archetype: 'The Co-creators' }],
          setting: { type: 'Infinite dimensional space', quality: 'malleable', time: 'creation time' },
          narrative_arc: 'ascending',
          lucidity: 3,
          tone: 'Creative, expansive, collaborative',
          interpretation: 'The dreamer is accessing their creative power and recognizing the collaborative nature of reality creation.',
          astro_context: {
            moon_phase: 'Waxing Gibbous',
            moon_sign: 'Gemini',
          ...
          recommendations: [
            { action: 'Explore your creative medium', timing: 'This week', why: 'Channel the creative power' },
          ],
        },
      },
    ],
  },
  {
    ...
    avatar_seed: 'shadow',
    email: 'the_shadow_walker@dreamscape.local',
    dreams: [
      {
        date: '2025-03-20',
        ...
        extraction: {
          ...
          characters: [{ label: 'Shadow Self', known: true, archetype: 'The Shadow' }],
          setting: { type: 'Underworld cavern', quality: 'alive', time: 'timeless' },
          narrative_arc: 'descending',
          lucidity: 3,
          tone: 'Dark, transformative, integrative',
          interpretation: 'Profound shadow integration dream. The dreamer has successfully integrated their repressed aspects.',
          astro_context: {
  ...
  },
  {
    ...
    avatar_seed: 'healer',
    email: 'the_healer@dreamscape.local',
    dreams: [
      {
        date: '2025-03-19',
        ...
        extraction: {
          ...
          characters: [{ label: 'Struggling Person', known: true, archetype: 'The Wounded' }],
          setting: { type: 'Luminous garden', quality: 'vital', time: 'eternal' },
          narrative_arc: 'ascending',
          lucidity: 3,
          tone: 'Compassionate, empowering, restorative',
          interpretation: 'The dreamer is recognizing their healing gifts and the nature of true healing.',
          astro_context: {
          ...
          recommendations: [
            { action: 'Develop your healing practice', timing: 'This month', why: 'The dream is calling you' },
          ],
        },
      },
    ],
  },
  {
    ...
    email: 'the_trickster@dreamscape.local',
    dreams: [
      {
        date: '2025-03-18',
        ...
        extraction: {
          ...
          characters: [{ label: 'The Trickster', known: false, archetype: 'The Trickster' }],
          setting: { type: 'Inverted reality', quality: 'chaotic', time: 'eternal' },
          narrative_arc: 'cyclical',
          lucidity: 3,
          tone: 'Playful, subversive, liberating',
          interpretation: 'The Trickster archetype is active, offering liberation through the recognition that reality is more fluid.',
          astro_context: {
            moon_phase: 'Full Moon',
  ...
  },
  {
    ...
    avatar_seed: 'lover',
    email: 'the_lover@dreamscape.local',
    dreams: [
      {
        date: '2025-03-17',
        ...
        extraction: {
          ...
          characters: [{ label: 'Unknown Lover', known: false, archetype: 'The Divine Beloved' }],
          setting: { type: 'Sacred dance space', quality: 'luminous', time: 'eternal' },
          narrative_arc: 'ascending',
          lucidity: 3,
          tone: 'Intimate, ecstatic, transcendent',
          interpretation: 'The dreamer is experiencing a vision of sacred union and soul-level connection.',
          astro_context: {
            moon_phase: 'Waxing Gibbous',
            moon_sign: 'Libra',
  ...
  },
  {
    ...
    avatar_seed: 'seeker',
    email: 'the_seeker@dreamscape.local',
    dreams: [
      {
        date: '2025-03-16',
        ...
        extraction: {
          ...
          characters: [{ label: 'Four Guides', known: false, archetype: 'The Wise Ones' }],
          setting: { type: 'Sacred mountain', quality: 'transformative', time: 'eternal' },
          narrative_arc: 'ascending',
          lucidity: 3,
          tone: 'Questing, revelatory, integrative',
          interpretation: 'The dreamer is on a genuine spiritual path and has reached a significant milestone.',
          astro_context: {
            moon_phase: 'Waxing Crescent',
            moon_sign: 'Sagittarius',
  ...
  },
  {
    ...
    avatar_seed: 'void',
    email: 'the_void_gazer@dreamscape.local',
    dreams: [
      {
        date: '2025-03-15',
        ...
        extraction: {
          ...
          interpretation: 'The dreamer has accessed the void consciousness—the quantum field of infinite potential.',
          astro_context: {
            moon_phase: 'New Moon',
            moon_sign: 'Pisces',
...
async function seedDreamers() {
  ...
  for (const dreamer of DREAMERS) {
    try {
      ...
      if (authError) {
        console.log(`⚠️  ${dreamer.handle}: Auth error: ${authError.message}`)
        continue
      }
